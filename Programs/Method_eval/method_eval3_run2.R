...
write.table(result1, file="Results_AGAIG_SD1_ME.05_rand.R")
...
write.table(result1, file="Results_AGAIG_SD1_ME.12_rand.R")
...
write.table(result1, file="Results_AGAIG_SD1_ME.25_rand.R")
...
write.table(result1, file="Results_AGAIG_SD1_ME.5_rand.R")
...
write.table(result1, file="Results_reverse_SD1_ME.05_rand.R")
...
write.table(result1, file="Results_reverse_SD1_ME.12_rand.R")
...
write.table(result1, file="Results_reverse_SD1_ME.25_rand.R")
...
write.table(result1, file="Results_reverse_SD1_ME.5_rand.R")
